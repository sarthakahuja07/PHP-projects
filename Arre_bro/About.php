...
<body>
    ...
    <div class="about container">
        <p class="fw-bold">Arre! bro. Top destination for trendy & aesthetic apparels. </p>
        </p>

        <p>Arre Bro is a fashion brand based in New Delhi, India. We have a unique combination of aestheticism and
            trend.
        </p>
        <p>
    ...
    <div class="about container">
        ...
        <p>B-9, Vasant Kunj, New Delhi, IN 110070
        </p>
        <p>
            info@arrebro.com <span class="fst-italic">(Monday to Saturday, 10:00am - 6:00pm)</span>
        </p>
    </div>
